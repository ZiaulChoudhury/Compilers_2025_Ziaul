...
; Function Attrs: alwaysinline nounwind ssp uwtable(sync)
define i32 @fun(i32 noundef %0, i32 noundef %1) #0 {
...
define i32 @main() #1 {
  ...
  %7 = call i32 (ptr, ...) @scanf(ptr noundef @.str, ptr noundef %5, ptr noundef %6)
...
attributes #0 = { alwaysinline nounwind ssp uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+complxnum,+crc,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+jsconv,+lse,+neon,+pauth,+ras,+rcpc,+rdm,+sha2,+sha3,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
